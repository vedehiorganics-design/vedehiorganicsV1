                      ...
                      <div className="flex justify-start">
                          <img
                             src="./two_friends.webp"
                              ...
                              className="rounded-2xl shadow-2xl w-full max-w-xs h-auto object-contain"
                              loading="lazy"
                              width="800"
                              height="600"
                          />
              ...
              <section className="bg-gradient-to-b from-emerald-50 to-white py-16">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                      <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
                          ...
                          <div>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.1427226213013!2d73.79088469999999!3d18.5676032!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf88cec26845%3A0x767b5e36ada2f00c!2sVedehi%20Organics!5e0!3m2!1sen!2sin!4v1768890020502!5m2!1sen!2sin" width="400" height="300" loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen ></iframe>
                          </div>
                      </div>
                  </div>
              </section>
                  ...
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                      ...
                      <div className="flex justify-center">
                          <div className="overflow-x-auto scrollbar-hide w-full max-w-4xl">
                              <div className="flex gap-8 pb-4 min-w-min justify-center px-4">
                      ...
                      <div className="flex justify-center gap-8 flex-wrap">
                          ...
                          <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-2xl shadow-lg max-w-sm">
                              ...
                              <div className="text-center">
                                  ...
                                  <a
                                      href="https://www.youtube.com/@vedehiorganics"
                                      target="_blank"
                                      rel="noopener noreferrer"
